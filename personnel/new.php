...
<body id="page-top">
 ...
 <table class="table table-striped table-bordered table-hover fetch-ins" id="dataTables-example fetch-ins" style="margin-top:1%;">
  <!--                 <thead>
          ...
          <div class="container">
            ...
            <form method="POST" id="application_form">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="toda_no" placeholder="Toda No."  required>
                  <!-- <select class="form-control" name ="toda_no">
                    <option>Select toda no</option>
                    <?php

                    $sql1 = 'select * from inspected';
        ...
        <!-- <input type="submit" name="btn_submit_sum" id="btn_submit" value="Submit" class="btn btn-success"> -->
