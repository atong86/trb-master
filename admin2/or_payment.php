  ...
  <?php require('nav.php');  ?>
        ...
        <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">ORDER OF PAYMENT</h1>
          </div>
        ...
        <div class="col-sm-2">
          <label style="margin-left:60%">₱ 100.00</label>
           ...
           <button type="button" class="btn btn-default" data-dismiss="modal" style="margin-bottom:1%;"><a href="http://localhost:8080/trb-master/admin2/"> Close</a></button>
          </form>
          </div>
        </div>
