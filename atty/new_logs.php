...
echo "<table border='1'  class='' id='dataTables-example' >
<tr>
...
<th><b>Inspected</b></td></th>
<th><b>Inspected by</b></td></th>
<th><b>Inspected date</b></td></th>


<th><b>Created</b></td></th>
<th><b>Created by</b></td></th>
<th><b>Created date</b></td></th>

<th><b>Created OOP</b></td></th>
<th><b>Created OOP by</b></td></th>
<th><b>Created OOP date</b></td></th>


<th><b>Payment</b></td></th>
<th><b>Payment Received by</b></td></th>
<th><b>Payment Received date</b></td></th>

<tbody id='myTable'>";
   foreach($payments as $package):

/*      $amount = number_format($package->total_amount,2);*/
    echo "<tr id=".$package->id_log.">";
    echo "<td >".$package->toda."</td>";
    echo "<td >".$package->toda_no."</td>";

    echo "<td >".$package->inspected."</td>";
    echo "<td >".$package->inspected_by."</td>";
    echo "<td >".$package->inspected_date."</td>";

    echo "<td >".$package->created_new."</td>";
    echo "<td >".$package->created_new_by."</td>";
    echo "<td >".$package->created_new_date."</td>";

    echo "<td >".$package->created_oop."</td>";
    echo "<td >".$package->created_oop_by."</td>";
    echo "<td >".$package->created_oop_date."</td>";

    echo "<td >".$package->payment_received."</td>";
    echo "<td >".$package->payment_received_by."</td>";
    echo "<td >".$package->payment_received_date."</td>";
     echo "</tr>";
