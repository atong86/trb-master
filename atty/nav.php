 ...
 <!-- Custom fonts for this template-->
  ...
  <div id="wrapper">
    ...
    <hr class="sidebar-divider my-0">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="../insp/index.php">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="../admin2/index.php">
          <i class="fas fa-fw fa-table"></i>
          <span>Dept. Head</span></a>
      </li>

      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="../treasury/index.php">
          <i class="fas fa-fw fa-table"></i>
          <span>Treasury</span></a>
      </li>
