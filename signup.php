...
$con = mysqli_connect('localhost','root','','trb_db_master');
$password ='';
  if(isset($_POST['btn_submit']))
    {
      ...
      $deleted = "0";
      $verified = "0";
      $insert = mysqli_query($con,"INSERT INTO trb_db_master.user_account VALUES(NULL,'".$fname."' ,'".$lname."', '".$phone_no."' ,'".$email_address."' ,'".$password."', '".$isAdmin."' ,'".$isBlocked."' ,'".$active."' ,'".$deleted."' ,'".$verified."');") or die(mysqli_error($con));
...
<footer class="page-footer blue">
        ...
        <div class="footer-copyright">
          ...
          <a class="grey-text text-lighten-4 right" href="#!">© TRB System 2020</a>
          </div>
        </div>
</footer>
